...
function Address(){
    ...
    function handleOnAddAddressClick(){
        setAddress(
            {...address,
    ...
    return (
        <div className="w-full min-h-screen bg-gray-300 gap-2 mt-[60px] flex flex-row">
            ...
            {!address.addAddress && address.addressArra.length!==0 && 
            <div className="w-[70%] min-h-screen m-3 rounded bg-white flex flex-col ml-1 p-2">
            <button className="flex flex-row ml-5 mt-10 w-[95%] border border-blue-500 mr-5 p-3">
            ...
            <p>Opta PG Bellandur Green Glen Layout</p>
            </div>
            </div>}
           {!address.addAddress && address.addressArra.length===0 && <div className="w-[70%] min-h-screen m-3 rounded bg-white items-center justify-center flex flex-col ml-1">
                  ...
                  <button className="p-3 pl-5 pr-5 rounded bg-blue-500 font-semibold mt-4 " onClick={()=>handleOnAddAddressClick()}>ADD ADDRESSES</button>
            </div>}
            {address.addAddress && <div className="w-[70%] min-h-screen m-3 rounded bg-white flex flex-col ml-1 ">
            ...
            <section className="flex flex-row justify-start mt-[30px] ml-12">
                ...
                <button className="p-3 text-blue-500 ml-8 font-semibold" onClick={()=>handleOnAddAddressClick()}>CANCEL</button>
            </section>
